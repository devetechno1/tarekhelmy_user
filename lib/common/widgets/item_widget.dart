      ...
      children: [
        Container(
          ...
          child: CustomInkWell(
            ...
            padding: (ResponsiveHelper.isDesktop(context) ? EdgeInsets.all(fromCartSuggestion ? Dimensions.paddingSizeExtraSmall : Dimensions.paddingSizeSmall) : const EdgeInsetsDirectional.only(top: Dimensions.paddingSizeSmall, bottom: 0,end: 0, start:  Dimensions.paddingSizeSmall)),
            child: TextHover(
              builder: (hovered) {
                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                ...
                                (isStore ? store!.address != null : item!.storeName != null) && !AppConstants.removeStores ? Text(
        ...
        (!isStore && isCornerTag! == false) ? Positioned(
          right: ltr ? null : 0.01, left: ltr ? 0.01 : null,
          child: CornerDiscountTag(
            bannerPosition: ltr ? CornerBannerPosition.topLeft : CornerBannerPosition.topRight,
            elevation: 0,
            discount: discount, discountType: discountType,
            freeDelivery: isStore ? store!.freeDelivery : false,
        )) : const SizedBox(),
