  ...
  static Future<void> loadData(bool reload, {bool fromModule = false}) async {
    ...
    await Future.wait([
      ...
      if(Get.find<SplashController>().module != null && !Get.find<SplashController>().configModel!.moduleConfig!.module!.isParcel!) ...{
        ...
        Get.find<ItemController>().getWeekendOfferItemList(reload, false, 'all'),
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (splashController) {
      ...
      return GetBuilder<HomeController>(builder: (homeController) {
        ...
        return Scaffold(
          appBar: ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(toolbarHeight: 15, backgroundColor: Theme.of(context).primaryColor,actions: const [SizedBox()],automaticallyImplyLeading: false),
            ...
            child: RefreshIndicator(
              onRefresh: () async {
                ...
                if (Get.find<SplashController>().module != null) {
                  ...
                  await Get.find<ItemController>().getWeekendOfferItemList(true, false, 'all');
