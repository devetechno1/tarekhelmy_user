...
class WebNewArrivalView extends StatefulWidget {
  ...
  @override
  State<WebNewArrivalView> createState() => _WebNewArrivalViewState();
}

class _WebNewArrivalViewState extends State<WebNewArrivalView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ItemController>(builder: (itemController) {
      List<Item>? newArrivalList = itemController.newArrivalItemList;

      if(newArrivalList != null && newArrivalList.length > 5 && isFirstTime){
        showForwardButton = true;
        isFirstTime = false;
      }

      return newArrivalList != null ? newArrivalList.isNotEmpty ? Stack(children: [
          Padding(
