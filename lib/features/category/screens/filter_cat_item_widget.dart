...
class FilterCatItemWidget extends StatelessWidget {
  final double? maxValue;
  final bool isStore;
  const FilterCatItemWidget({super.key, required this.maxValue, required this.isStore});
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Container(
        ...
        child: GetBuilder<CategoryController>(builder: (searchController) {
